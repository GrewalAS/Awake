...
- (void)initializer
{
    ...
    for (NSUInteger i = 0; i < 2; ++i)
    {
        ...
        [self addConstraints:@[
                               ...
                               [NSLayoutConstraint constraintWithItem:clipView attribute:alignmentAttribute relatedBy:NSLayoutRelationEqual toItem:self attribute:alignmentAttribute multiplier:1.0 constant:10.0],
                               clipConstraint,
                               ]];
        ...
        [self addConstraints:@[
                               ...
                               /*****The Next two constraints are customized*****/
                               [NSLayoutConstraint constraintWithItem:buttonView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:clipView attribute:NSLayoutAttributeTop multiplier:1.0 constant:10.0],
                               [NSLayoutConstraint constraintWithItem:buttonView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:clipView attribute:NSLayoutAttributeBottom multiplier:1.0 constant:-10.0],
...
- (void)rightUtilityButtonHandler:(id)sender
{
    ...
    {
        /*****Customized*****/
        [self.delegate swipeableTableViewCell:(SWTableViewCell*)self didTriggerRightUtilityButtonWithIndex:utilityButtonIndex];
    }
}
